...
export const en: Translations = {
  ...
  kanban: {
    ...
    logAt: ")",
    newTask: "New Task",
    newTaskDialog_title: "New Task",
    newTaskDialog_assignee: "Assignee",
    newTaskDialog_priority: "Priority",
    newTaskDialog_description: "Description",
    newTaskDialog_skills: "Skills",
    newTaskDialog_parentTask: "Parent Task",
    newTaskDialog_workspaceKind: "Workspace Kind",
    newTaskDialog_workspacePath: "Workspace Path",
    newTaskDialog_goalMode: "Goal Mode",
    newTaskDialog_goalMaxTurns: "Max Turns",
    newTaskDialog_create: "Create Task",
    newTaskDialog_creating: "Creating...",
    newTaskDialog_error: "Failed to create task",
    newTaskDialog_titlePlaceholder: "Enter task title...",
  },
};
